<div x-show="sidebarOpen" @click="sidebarOpen = false" class="fixed inset-0 z-20 bg-black/50 lg:hidden transition-opacity"></div>
        <aside 
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a @click="activeMenu = 'User'" href="/users" 
                    class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 group"
                ...
                <a @click="activeMenu = 'Event'" href="/events" 
                ...
                <a @click="activeMenu = 'Category'" href="/categories" 
                    class="flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200"
            ...
            <div class="absolute bottom-0 w-full p-4 border-t border-slate-800 bg-slate-900/50">
                <div class="flex items-center gap-3 px-2">
                    <img src="{{ asset('/Image/Preview.png') }}" alt="" class="w-10 h-10 rounded-full flex items-center justify-center font-bold">
                    <div>
