            ...
            <div class="flex items-center justify-between px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="hidden sm:flex flex-1 items-center">
                    <p class="text-sm text-gray-600">
                        Menampilkan <span class="font-medium">1</span> sampai <span class="font-medium"><?php echo e(count($listevent ?? [])); ?></span> hasil
                    </p>
                </div>
...
<?php endif; ?><?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/dashboard/events/events.blade.php ENDPATH**/ ?>