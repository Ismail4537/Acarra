    ...
    <div class="flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="w-full max-w-2xl">
            <div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <form action="<?php echo e(isset($event) ? route('event.update', $event->id) : route('event.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" value="<?php echo e(old('title', $event->title ?? '')); ?>" placeholder="Contoh: Konser Musik Galau Fest"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="location" value="<?php echo e(old('location', $event->location ?? '')); ?>" placeholder="Contoh: ICE BSD, Tangerang"
                                   class="w-full rounded-xl border border-gray-300 px-5 py-3 text-gray-800 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm font-medium">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="datetime-local" name="start_date_time" value="<?php echo e(old('start_date_time', $event->start_date_time ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_date_time" value="<?php echo e(old('end_date_time', $event->end_date_time ?? '')); ?>"
                                       class="w-full rounded-xl border border-gray-300 px-5 py-3 text-gray-800 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm font-medium text-sm">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="category" class="w-full rounded-xl border border-gray-300 px-5 py-3 text-gray-800 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm font-medium bg-white">
                                <option value="" disabled <?php echo e(!isset($event) ? 'selected' : ''); ?>>Pilih Kategori...</option>
                                
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" <?php echo e(old('category', isset($event) && $event->category_id == $category->id) ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="price" value="<?php echo e(old('price', $event->price ?? '')); ?>" placeholder="0 (Isi 0 jika gratis)"
                            class="w-full rounded-xl border border-gray-300 px-5 py-3 text-gray-800 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm font-medium">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <?php endif; ?>
                            <select name="status" class="w-full rounded-xl border border-gray-300 px-5 py-3 text-gray-800 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm font-medium bg-white <?php echo e(isset($event) && $event->status ? '' : 'hidden'); ?>">
                                <option value="scheduled" <?php echo e(old('status',isset($event) && $event->status ? 'selected' : '')); ?>>Scheduled</option>
                                <option value="ongoing" <?php echo e(old('status',isset($event) && $event->status == 'ongoing' ? 'selected' : '')); ?>>Ongoing</option>
                                <option value="completed" <?php echo e(old('status',isset($event) && $event->status == 'completed' ? 'selected' : '')); ?>>Completed</option>
                                <option value="cancelled" <?php echo e(old('status',isset($event) && $event->status == 'cancelled' ? 'selected' : '')); ?>>Cancelled</option>
                            </select>
...
<?php endif; ?><?php /**PATH C:\Users\iafat\Herd\Acarra\resources\views/front-page/event/form.blade.php ENDPATH**/ ?>