            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="judul" id="title" required
                        value="<?php echo e(old('judul', $event['title'] ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <select name="kategori" id="kategori" required
                            ...
                            <option value="seminar"
                                <?php echo e(old('kategori', $event['category_id'] ?? '') == 'seminar' ? 'selected' : ''); ?>>
                                Seminar</option>
                            <option value="workshop"
                                <?php echo e(old('kategori', $event['category_id'] ?? '') == 'workshop' ? 'selected' : ''); ?>>
                                Workshop</option>
                            <option value="expo"
                                <?php echo e(old('kategori', $event['category_id'] ?? '') == 'expo' ? 'selected' : ''); ?>>Expo
                            </option>
                        </select>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="lokasi" id="location" required
                            value="<?php echo e(old('lokasi', $event['location'] ?? '')); ?>"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm shadow-sm transition">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="tanggal" id="date" required
                            value="<?php echo e(old('tanggal', isset($event['start_date_time']) ? date('Y-m-d\TH:i', strtotime($event['end_date_time'])) : '')); ?>"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm shadow-sm transition">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="alamat_lengkap" id="address" rows="2" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm shadow-sm transition"><?php echo e(old('alamat_lengkap', $event['location'] ?? '')); ?></textarea>
                </div>
            </div>
